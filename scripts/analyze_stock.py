...
def run_ddm_valuation(yf_data, div_series, cost_of_equity, analyst_ltg=None,
    ...
    #    dividendRate is a forward rate, so year 1 is pinned at dps.
    ...
    mc = monte_carlo_ddm(
        ...
        re_tg_corr=MC_WACC_TG_CORRELATION, seed=seed, dps_is_forward=True)
    if mc:
...
def _run_phase2_analysis(qualifying, screen_cache, prices_dir,
    ...
    for ticker in qualifying:
        ...
        try:
            ...
            _epv_eff_tax, _epv_tax_source = through_cycle_tax_rate(inc_stmt)
