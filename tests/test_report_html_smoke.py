...
def _rich_row():
    ...
    return {
        ...
        'beta_raw': 1.35,
        'beta_adjusted': 1.28,
        'beta_shrink_weight': 0.81,
        'beta_r2': 0.42,
        'beta_se': 0.10,
        'beta_n_obs': 260,
        'beta_r2_class': 'directional',
        'beta_source': 'weekly_5y',
        'beta_warnings': None,
        'rolling_betas': {
            '1y': {'beta': 1.41, 'shrunk': 1.12, 'r2': 0.38, 'se': 0.24, 'n': 52},
            '3y': {'beta': 1.33, 'shrunk': 1.25, 'r2': 0.41, 'se': 0.13, 'n': 156},
            '5y': {'beta': 1.35, 'shrunk': 1.28, 'r2': 0.42, 'se': 0.10, 'n': 260},
            'stability': 0.034,
        },
